export const DEFAULT_PATH = 'essentials-vibecoding';
export const TITLE = '바이브코딩 에센셜 with claude code';
export const DESCRIPTION = 'claude code와 함께하는 바이브코딩 핵심 기능과 활용법';
