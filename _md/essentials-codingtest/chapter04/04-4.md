...
def solution(N, number):
    """
    숫자 N을 최소 몇 번 사용해서 number를 만들 수 있는지
    8번 초과면 -1 반환
    """
    if N == number:
        return 1
...
print(solution(5, 12))   # 4 (5+5+5/5 = 11... 아니고 (55+5)/5=12)
...
* (DP) 피보나치 수: https://school.programmers.co.kr/learn/courses/30/lessons/12945
* (DP) 정수 삼각형: https://school.programmers.co.kr/learn/courses/30/lessons/43105
