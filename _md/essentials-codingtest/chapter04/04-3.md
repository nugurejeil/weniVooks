...
```python
def cut_lan_cables(cables, n):
    """
    길이가 cables인 랜선들을 잘라서
    n개 이상의 랜선을 만들 때
    만들 수 있는 랜선의 최대 길이
    """
...
n = 11
print(cut_lan_cables(cables, n))  # 200
```
...
print(immigration(6, [7, 10]))  # 28
# 28분: 7분 심사관이 4명, 10분 심사관이 2명 = 6명
```
...
* (이진탐색) 랜선 자르기: https://www.acmicpc.net/problem/1654
* (이진탐색) 나무 자르기: https://www.acmicpc.net/problem/2805
* (이진탐색) 입국심사: https://school.programmers.co.kr/learn/courses/30/lessons/43238
* (이진탐색) 징검다리: https://school.programmers.co.kr/learn/courses/30/lessons/43236
