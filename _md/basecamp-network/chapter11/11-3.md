...
```mermaid
flowchart LR
    A["1957 - 스푸트니크 쇼크"] --> B["1958 - ARPA 창설"]
    B --> C["1969 - ARPANET"]
    C --> D["1989 - WWW 제안"]
    D --> E["1990 - 최초 웹 서버"]
    E --> F["1993 - 모자이크 브라우저"]
...
### 11.3.1.1 Time-sharing (시분할 시스템)의 등장
...
### 11.3.1.2 스푸트니크 쇼크 (1957년 10월 4일)
...
### 11.3.1.3 쿠바 미사일 위기 (1962년 10월 14일)
...
### 11.3.2.1 약속된 승리의 장소. CERN(Conseil Européen pour la Recherche Nucléaire)
...
### 11.3.4.1 칙칙한 웹 세상에 등장한 모자이크(Mosaic) 브라우저
...
### 11.3.4.3 넷스케이프 내비게이터(NN)의 배 다른 동생, 인터넷 익스플로러
