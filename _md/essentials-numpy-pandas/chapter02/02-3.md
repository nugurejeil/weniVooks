...
**인덱싱**(indexing)은 파이썬의 인덱싱과 유사합니다. `arr[index]`와 같은 형태입니다.
...
**슬라이싱**(slicing)도 파이썬과 유사하게 `arr[start:end:step]` 형태로 사용합니다.
...
**불리언 인덱싱**(boolean indexing)은 조건에 맞는 요소만 선택하는 방법입니다. `arr[condition]` 형태로 사용합니다. 여기서 condition은 True/False 값을 가지는 배열이며, arr와 condition의 크기는 동일해야 합니다.
...
**팬시 인덱싱**(fancy indexing)은 정수 배열을 사용하여 여러 인덱스의 요소를 동시에 선택하는 방법입니다. `arr[[index1, index2, ...]]` 형태로 사용합니다.
...
![](/images/basecamp-numpy-pandas/chapter02/concatnate_2.png 'np.concatenate')
...
![](/images/basecamp-numpy-pandas/chapter02/vstack_2.png 'np.vstack')
...
![](/images/basecamp-numpy-pandas/chapter02/hstack_2.png 'np.hstack')
...
![](/images/basecamp-numpy-pandas/chapter02/split_2.png 'np.split')
...
![](/images/basecamp-numpy-pandas/chapter02/array_split_2.png 'np.array_split')
...
![](/images/basecamp-numpy-pandas/chapter02/hsplit_2.png 'np.hsplit')
...
![](/images/basecamp-numpy-pandas/chapter02/vsplit_2.png 'np.vsplit')
