...
이 장에서는 UI/UX 디자인 도구인 Figma와 MCP를 활용하여 디자인을 코드로 변환하는 방법을 다룹니다. Figma Dev Mode MCP 설정과 활용법을 배웁니다.
...
<highlight>Figma는 UI/UX 디자인을 위한 클라우드 기반 협업 디자인 플랫폼입니다.</highlight>
...
<highlight>Figma MCP는 Figma와 AI가 직접 대화할 수 있게 해주는 다리입니다.</highlight>
