...
| 개념 | 설명 |
| --- | --- |
| 숫자 연산 | 더하기, 빼기, 나누기, 곱하기 등의 산술 연산 |
| 딕셔너리 | key-value 쌍으로 데이터를 저장하는 자료형 |
| f-string | 문자열 안에 변수를 삽입하는 편리한 방법 |
...
<highlight>딕셔너리는 이름표(key)로 값(value)을 찾는 자료구조입니다. 사전에서 단어를 찾듯이 key를 통해 원하는 값을 빠르게 찾을 수 있습니다.</highlight>
