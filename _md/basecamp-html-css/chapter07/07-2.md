...
<highlight>flex가 1차원 레이아웃을 담당했다면 2차원 레이아웃은 grid가 담당합니다.</highlight> 행과 열을 동시에 제어할 수 있어 복잡한 레이아웃을 쉽게 만들 수 있습니다. 그리드를 구성하는 기본적인 용어를 알아보겠습니다.
