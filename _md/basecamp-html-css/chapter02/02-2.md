...
우리 수업은 기초 강의이기 때문에 모든 태그를 전부 다루지는 않았습니다. 아래 표를 참고하여 필요한 태그를 정리하세요. **CheatSheet**는 보통 한 장에 모든 정보를 담아놓은 요약본을 말합니다.

<highlight>인터넷에 좋은 CheatSheet가 많으니, 자신에게 맞는 CheatSheet를 찾아서 사용하세요!</highlight>

::a[HTML Cheat Sheet]{class="btn-link" href="https://htmlcheatsheet.com/" target="\_blank"}
::a[MDN HTML 요소 레퍼런스]{class="btn-link" href="https://developer.mozilla.org/ko/docs/Web/HTML/Element" target="\_blank"}
