...
<highlight>CSS 상속은 부모 요소에 적용된 스타일 속성이 자식 요소에게 전달되는 메커니즘을 말합니다.</highlight> 부모 요소의 속성을 상속받고, 자식 요소에게도 해당 속성을 상속합니다. 따라서 스타일이 HTML 문서의 계층 구조를 따라 "흘러내리는" 방식으로 적용됩니다. 상속을 통해 전체적인 **디자인의 일관성을 유지하면서도 코드의 중복을 줄일** 수 있습니다.
