...
<highlight>CSS는 여러 선택자를 사용하기 때문에 한 개의 요소를 다양하게 표현할 수 있고, 여러 스타일이 적용될 수 있습니다.</highlight> 이 때, 동일한 속성을 작성하면 스타일이 충돌할 수 있는데 어떤 스타일을 적용할지 결정하는 규칙이 존재합니다. 어떤 스타일을 적용할지를 정하는 우선순위 체계가 있으며, 이를 **선택자 우선 순위**라고 합니다.
