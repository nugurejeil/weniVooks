...
CSS Box Model은 웹 페이지 레이아웃의 근간을 이루는 중요한 개념입니다. 모든 HTML 요소는 하나의 '**상자**'로 취급되며, 웹 페이지는 이런 수많은 상자들이 모여있는 것이라고 할 수 있습니다.
...
2. 가운데 정렬
   좌우 margin을 auto로 설정하면 요소의 왼쪽과 오른쪽에 갸능한 만큼의 **여백을 동일하게 갖기** 때문에 가운데 정렬을 할 수 있습니다.
