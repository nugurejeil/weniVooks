...
`overflow: hidden`이나 `display:none`을 사용할 때 접근성에 주의해야 합니다. 스크린 리더는 `overflow: hidden`으로 숨겨진 콘텐츠도 대부분 읽을 수 있습니다. 그러나 이는 시각적으로 보이지 않는 콘텐츠를 스크린 리더 사용자에게 제공하여 혼란을 줄 수 있습니다.
