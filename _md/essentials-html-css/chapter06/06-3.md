...
<highlight>시멘틱 마크업은 인터넷에 떠다니는 정보들을 컴퓨터가 이해할 수 있고, 그 정보를 가공할 수 있도록 하는 것이 목적입니다.</highlight> 또한, 웹 접근성을 향상시켜 정보 격차를 해소하는 데 도움을 줍니다.
...
- ::a[W3C]{class='btn-link' href="https://www.w3.org/" target="\_blank"}
- ::a[MDN]{class='btn-link' href="https://developer.mozilla.org/ko/" target="\_blank"}
