...
- **`h1`**은 페이지의 주요 제목으로, 한 페이지에 하나를 사용하는 것을 권장합니다.ex) 로고
...
- 중요한 내용, 경고, 핵심 정보를 나타낼 때 사용합니다. 의미적으로 “이 부분은 특히 중요하다”는 것을 표현합니다.
- 기본적으로 굵게 표시되지만, 핵심은 시각 효과가 아니라 의미(importance) 입니다.
- 몇몇 스크린 리더는 `<strong>`을 만나면 보통 억양을 달리하거나 강조하여 읽어, 사용자가 중요한 정보를 인식할 수 있도록 도와줍니다.
...
- 기본적으로 기울임꼴(italic)로 표시되지만, 중요한 것은 **억양·강조의 의미 변화**입니다.
...
- 문장 흐름과 다른 성격의 텍스트를 나타낼 때 사용하며, 기본적으로 기울임꼴로 표시됩니다.
- 외국어, 용어, 생각, 기술 용어, 인용 속 등장인물의 말투, 아이콘 글리프 등 주변 텍스트와 구분되는 내용을 표현할 때 사용합니다.
