...
이 장에서는 노션의 인라인 블록에 대해 알아봅니다. 인라인 블록은 텍스트 블록 안에서 사용할 수 있는 다양한 하위 요소들입니다.
...
<highlight>
인라인 핵심 포인트<br/>
- 인라인은 텍스트 블록 안에서 사용하는 하위 요소<br/>
- @로 사용자/페이지 멘션, 리마인더로 알림 설정 가능<br/>
- /이모지 또는 단축키(Win: 윈도우+.)로 이모지 삽입<br/>
- 인라인 수학공식으로 $E=mc^2$ 같은 수식을 텍스트 내에 삽입 가능
</highlight>