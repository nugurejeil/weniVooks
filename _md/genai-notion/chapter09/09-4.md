...
sequenceDiagram
    ...
    T->>G: GitHub에 커밋
    G->>G: 자동 배포
    Note over N: 임베드 URL은 동일<br/>자동으로 최신 버전 반영!
    N->>T: 업데이트 완료
...
:::div{.callout}
**최종 과제**: 이번 챕터에서 배운 내용을 바탕으로, 여러분 회사(또는 가상 회사)의 랜딩 페이지를 ChatGPT로 만들고 Notion에 임베드해보세요. 완성된 페이지를 팀원들과 공유하고 피드백을 받아보세요!
:::

**축하합니다!** 이것으로 "GenAI와 Notion을 활용한 AX 전환" 과정을 모두 마쳤습니다. 이제 여러분은 생성형 AI와 노션을 활용하여 업무를 혁신할 수 있는 도구와 지식을 갖추게 되었습니다. 🎉
