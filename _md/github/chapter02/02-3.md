...
- Git은 소스코드 및 파일의 변경 내역을 저장하는 분산 버전 관리 시스템입니다.
...
- <추천 서적>
  ::a[(무료, 공식) ProGit]{class="btn-link" href="https://git-scm.com/book/ko/v2" target="\_blank"}
  ::a[(유료) 팀 개발을 위한 Git, GitHub 시작하기]{class="btn-link" href="https://www.aladin.co.kr/shop/wproduct.aspx?ISBN=K712636023&start=pnaver_02" target="\_blank"}

- <추천 강의>
  ::a[(무료) 지옥에서 온 깃]{class="btn-link" href="https://www.inflearn.com/course/%EC%A7%80%EC%98%A5%EC%97%90%EC%84%9C-%EC%98%A8-git" target="\_blank"}
  ::a[(유료) 팀 개발을 위한 Git, GitHub 입문]{class="btn-link" href="https://www.inflearn.com/course/%ED%8C%80%EA%B0%9C%EB%B0%9C-%EA%B9%83-%EA%B9%83%ED%97%88%EB%B8%8C" target="\_blank"}
  ::a[(유료,심화) 제대로 파는 Git & GitHub - by 얄코]{class="btn-link" href="https://inf.run/m8hL" target="\_blank"}
- 공식문서
  ::a[Reference]{class="btn-link" href="https://git-scm.com/docs" target="\_blank"}
