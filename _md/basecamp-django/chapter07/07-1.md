...
<highlight>도서관 관리 시스템(LMS) 프로젝트는 Django를 활용하여 도서 관리, 대출/반납, 예약 기능을 구현하는 실습으로, 사용자와 사서 권한에 따른 기능 분리를 포함합니다.</highlight>
...
```mermaid
flowchart TD
    subgraph users["사용자 유형"]
        A["일반 사용자<br>대출/반납/예약"]
        B["사서<br>도서/회원 관리"]
    end
